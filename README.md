...
* [urdfdom](https://github.com/ros/urdfdom) ⭐ 132 | 🐛 57 | 🌐 C++ | 📅 2026-07-30 - Reference C++ URDF parser implementation mantained by OpenRobotics. \[BSD]
...
* [urdf-rs](https://github.com/openrr/urdf-rs) ⭐ 49 | 🐛 9 | 🌐 Rust | 📅 2026-06-30 - URDF parser using [serde-xml-rs](https://github.com/RReverser/serde-xml-rs) ⭐ 331 | 🐛 38 | 🌐 Rust | 📅 2026-02-05 for Rust. \[APACHE2]

#### Julia

* [MeshCatMechanisms.jl](https://github.com/JuliaRobotics/MeshCatMechanisms.jl) ⭐ 42 | 🐛 3 | 🌐 Julia | 📅 2024-12-05 - 3D Visualization of mechanisms and URDFs using [MeshCat.jl](https://github.com/rdeits/MeshCat.jl) ⭐ 254 | 🐛 25 | 🌐 Julia | 📅 2025-10-14 and [RigidBodyDynamics.jl](https://github.com/JuliaRobotics/RigidBodyDynamics.jl) ⭐ 309 | 🐛 40 | 🌐 Julia | 📅 2024-11-08 . \[MIT]
...
* [Awesome Robot Descriptions](https://github.com/robot-descriptions/awesome-robot-descriptions#readme) ⭐ 1,631 | 🐛 2 | 📅 2026-08-04 - A curated list of awesome robot descriptions, most in URDF or Xacro formats.
...
* [URDFly](https://github.com/Democratizing-Dexterous/URDFly) ⭐ 244 | 🐛 5 | 🌐 Python | 📅 2026-03-29 - URDFly is a Python-based toolkit for working with URDF files, providing tools for parsing, visualizing, and analyzing robotic systems defined in URDF format, with a focus on axes visulazation, urdf editing, MDH parameter conversion, kinematics calculation, and dynamics regressor codegen.
...
* [jupytercad\_urdf](https://github.com/jupytercad/JupyterCAD-urdf/) ⭐ 5 | 🐛 1 | 🌐 TypeScript | 📅 2026-01-20 - A JupyterLab extension allowing export of CAD designs to URDF.
