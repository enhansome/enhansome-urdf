...
* [urdfdom](https://github.com/ros/urdfdom) ⭐ 137 | 🐛 58 | 🌐 C++ | 📅 2026-09-16 - Reference C++ URDF parser implementation mantained by OpenRobotics. \[BSD]
...
* [urdf\_parser\_py](https://github.com/ros/urdf_parser_py) ⭐ 108 | 🐛 21 | 🌐 Python | 📅 2025-12-18 - Reference Python URDF parser mantained by OpenRobotics. \[BSD]
...
* [Awesome Robot Descriptions](https://github.com/robot-descriptions/awesome-robot-descriptions#readme) ⭐ 1,659 | 🐛 2 | 📅 2026-09-12 - A curated list of awesome robot descriptions, most in URDF or Xacro formats.
...
* [Unity-Technologies/URDF-Importer](https://github.com/Unity-Technologies/URDF-Importer) ⭐ 334 | 🐛 36 | 🌐 C# | 📅 2023-10-02 - URDF Importer allows you to import a robot defined in URDF format in a [Unity scene](https://unity.com). \[APACHE]
...
* [xacrodoc](https://github.com/adamheins/xacrodoc) ⭐ 74 | 🐛 0 | 🌐 Python | 📅 2026-04-20 - A wrapper around xacro providing friendly interfaces to compile xacro files to plain URDF or MJCF from Python or the command line. No ROS installation is required.
* [jupytercad\_urdf](https://github.com/jupytercad/JupyterCAD-urdf/) ⭐ 6 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-16 - A JupyterLab extension allowing export of CAD designs to URDF.
